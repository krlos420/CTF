...
public class Main {
    static ArrayList <Participante> participantesTotales;
            ...
            if (menuC == 2) {
                ...
                if (menuG == 2) {
                    ...
                    do {
                        ...
                        if (menuAp == 1) {
                            Junior j = new Junior();
                            Junior j2 = j.añadirJunior();
                            try {
                                j.agregarParticipante(j2, participantesTotales);
                        ...
                        if (menuAp == 2) {
                            ...
                            Especialista e2 = e.añadirEspecialista();
                            try {
                                e.agregarParticipante(e2, participantesTotales);
